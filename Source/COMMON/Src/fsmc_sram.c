...
/**
  ...
  *         on the SRAM.
  * @param  None 					  |RCC_APB2Periph_AFIO
  * @retval None
  */
void FSMC_SRAM_Init(void)
{
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD | RCC_APB2Periph_GPIOG | RCC_APB2Periph_GPIOE |  RCC_APB2Periph_GPIOB |
...
void FSMC_SRAM_WriteBuffer(uint16* pBuffer, uint32 WriteAddr, uint32 NumHalfwordToWrite)
{
  for(; NumHalfwordToWrite != 0; NumHalfwordToWrite--) /* while there is data to write */
  {
    ...
    *(uint16 *) (Bank1_SRAM3_ADDR + WriteAddr) = *pBuffer++;
...
void FSMC_SRAM_ReadBuffer(uint16* pBuffer, uint32 ReadAddr, uint32 NumHalfwordToRead)
{
  for(; NumHalfwordToRead != 0; NumHalfwordToRead--) /* while there is data to read */
  {
    ...
    *pBuffer++ = *(__IO uint16*) (Bank1_SRAM3_ADDR + ReadAddr);
